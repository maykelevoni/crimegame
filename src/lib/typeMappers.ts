...
export const mapSupabasePlayerToGamePlayer = (
  ...
  return {
    ...
    stats: {
      ...
      bankBalance: (supabasePlayer.bank_balance as number) || 0,
      lastInterestClaim: supabasePlayer.last_interest_claim as string,
      ...
      prisonSentence: (supabasePlayer.prison_sentence as number) || 0,
      crimeType: supabasePlayer.crime_type as string,
      imprisonedAt: supabasePlayer.imprisoned_at as string,
      activeLoans: [], // Will be loaded separately from loans table
      creditScore: (supabasePlayer.credit_score as number) || 650,
      totalDebt: (supabasePlayer.total_debt as number) || 0,
      loanHistory: (supabasePlayer.loan_history as string[]) || [],
    },
...
export const mapGamePlayerToSupabasePlayer = (
  ...
  return {
    ...
    bank_balance: gamePlayer.stats.bankBalance,
    last_interest_claim: gamePlayer.stats.lastInterestClaim,
    ...
    prison_sentence: gamePlayer.stats.prisonSentence,
    crime_type: gamePlayer.stats.crimeType,
    imprisoned_at: gamePlayer.stats.imprisonedAt,
    credit_score: gamePlayer.stats.creditScore,
    total_debt: gamePlayer.stats.totalDebt,
    loan_history: gamePlayer.stats.loanHistory,
    user_id: userId,
  };
};
