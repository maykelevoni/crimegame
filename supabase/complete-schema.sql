-- =====================================================
-- SCHEMA COMPLETO DO URBAN HUSTLE
-- =====================================================
...
CREATE TABLE IF NOT EXISTS public.robberies (
    ...
    success_rate INTEGER DEFAULT 50, -- 0-100
    base_reward INTEGER DEFAULT 100,
    max_reward INTEGER DEFAULT 1000,
    risk_level INTEGER DEFAULT 1, -- 1-10
    required_equipment TEXT[], -- Array de equipamentos necessários
...
-- Negócios dos jogadores (atualizar a tabela existente)
...
CREATE TABLE IF NOT EXISTS public.treatments (
    ...
    duration_minutes INTEGER DEFAULT 0, -- Para tratamentos que duram tempo
...
-- Histórico de tratamentos (atualizar a tabela existente)
...
CREATE TABLE IF NOT EXISTS public.casino_games (
    ...
    house_edge DECIMAL(3,2) DEFAULT 0.05, -- 5% vantagem da casa
...
CREATE TABLE IF NOT EXISTS public.casino_history (
    ...
    game_result TEXT NOT NULL, -- JSON com detalhes do jogo
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS public.nightlife_characters (
    ...
    effects JSONB DEFAULT '{}', -- Efeitos especiais
    available BOOLEAN DEFAULT TRUE,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS public.bank_accounts (
    ...
    interest_rate DECIMAL(3,2) DEFAULT 0.01, -- 1% ao dia
...
CREATE TABLE IF NOT EXISTS public.prisoners (
    ...
    escape_difficulty INTEGER DEFAULT 5, -- 1-10
    available BOOLEAN DEFAULT TRUE,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
